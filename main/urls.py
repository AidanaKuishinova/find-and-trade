...
urlpatterns = [
    ...
    path('responds_companies/<int:id>/', views.RespondsCompaniesDetailView.as_view(), name='responds_companies'),
    path('set_state,', views.set_state, name='set_state'),
    path('get_thread/<int:first_id>/<int:second_id>/', views.get_thread, name='get_thread'),
